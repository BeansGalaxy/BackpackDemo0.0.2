...
import com.beansgalaxy.backpack.entity.BackpackMenu;
import com.beansgalaxy.backpack.entity.BackpackScreen;
...
public class Backpack { public static final String MODID = "backpack";
    ...
    public static RegistryObject<MenuType<BackpackMenu>> MENU = MENUS.register("backpack_menu", () -> new MenuType<>(BackpackMenu::new, FeatureFlags.DEFAULT_FLAGS));
    ...
    private void setupClient(final FMLClientSetupEvent event) {
        MenuScreens.register(MENU.get(), BackpackScreen::new);
    }
